...
export const createAcademicTerm = AsyncHandler(
  async (
    req: Request<Record<string, never>, any, CreateAcademicTermBody>,
    res: Response
  ): Promise<void> => {
 ...
 * @access Private
 */
export const getAcademicTerms = AsyncHandler(
 ...
 * @access Private
 */
export const getAcademicTerm = AsyncHandler(
 ...
 * @access Private
 */
export const updateAcademicTerms = AsyncHandler(
  async (
    req: Request<{ id: string }, any, UpdateAcademicTermBody>,
    res: Response
  ): Promise<void> => {
    const { name, description, duration } = req.body;
