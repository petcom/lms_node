 ...
 * @access Private
 */
export const createClassLevel = AsyncHandler(async (req: Request<{}, {}, CreateClassLevelBody>, res: Response): Promise<void> => {
 ...
 * @access Private
 */
export const updateClassLevel = AsyncHandler(async (req: Request<{ id: string }, {}, UpdateClassLevelBody>, res: Response): Promise<void> => {
  const { name, description } = req.body;
