 ...
 */
export const createQuestion = AsyncHandler(async (req: Request<{ examID: string }, {}, CreateQuestionBody>, res: Response): Promise<void> => {
  const {
    question,
    optionA,
    optionB,
 ...
 * @access Private Teachers Only
 */
export const getQuestion = AsyncHandler(async (req: Request<{ id: string }>, res: Response): Promise<void> => {
 ...
 * @access Private Teachers Only
 */
export const updateQuestion = AsyncHandler(async (req: Request<{ id: string }, {}, UpdateQuestionBody>, res: Response): Promise<void> => {
  const {
    question,
    optionA,
    optionB,
