 ...
 * @access Private
 */
export const createYearGroup = AsyncHandler(async (req: Request<{}, {}, CreateYearGroupBody>, res: Response): Promise<void> => {
 ...
 * @access Private
 */
export const getYearGroup = AsyncHandler(async (req: Request<{ id: string }>, res: Response): Promise<void> => {
 ...
 * @access Private
 */
export const updateYearGroup = AsyncHandler(async (req: Request<{ id: string }, {}, UpdateYearGroupBody>, res: Response): Promise<void> => {
  const { name, academicYear } = req.body;
 ...
 * @access Private
 */
export const deleteYearGroup = AsyncHandler(async (req: Request<{ id: string }>, res: Response): Promise<void> => {
