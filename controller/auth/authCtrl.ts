 ...
 * @access  Private
 */
export const logout = AsyncHandler(async (req: Request<{}, {}, LogoutRequestBody>, res: Response): Promise<void> => {
 ...
 * @access  Public
 */
export const refreshToken = AsyncHandler(async (req: Request<{}, {}, RefreshTokenRequestBody>, res: Response): Promise<void> => {
    const { refreshToken } = req.body;
