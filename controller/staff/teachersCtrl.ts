 ...
 * @access      Private
 */
export const adminRegisterTeacher = expressAsyncHandler(async (req: Request<{}, {}, RegisterTeacherBody>, res: Response): Promise<void> => {
 ...
 * @access      Public
 */
export const loginTeacher = expressAsyncHandler(async (req: Request<{}, {}, LoginTeacherBody>, res: Response): Promise<void> => {
 ...
 */
export const getAllTeachersAdmin = expressAsyncHandler(async (_req: Request, res: Response): Promise<void> => {
 ...
 * @access      Private admin only
 */
export const getTeacherByAdmin = expressAsyncHandler(async (req: Request<{ teacherID: string }>, res: Response): Promise<void> => {
 ...
 */
export const getTeacherProfile = expressAsyncHandler(async (req: Request, res: Response): Promise<void> => {
 ...
 * @access      Private Teacher Only
 */
export const teacherUpdateProfile = expressAsyncHandler(async (req: Request<{}, {}, UpdateTeacherProfileBody>, res: Response): Promise<void> => {
 ...
 * @access      Private Admin Only
 */
export const adminUpdateTeacher = expressAsyncHandler(async (req: Request<{ teacherID: string }, {}, AdminUpdateTeacherBody>, res: Response): Promise<void> => {
