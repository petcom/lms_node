...
const { objectId, pagination, academicYear, classLevel, academicTerm, date } = require('./common');
...
const createExam = {
  body: Joi.object({
    ...
    examTime: Joi.string().pattern(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/).required(),
